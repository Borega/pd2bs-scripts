...
var Misc = {
	...
	logItem: function (action, unit, keptLine) {
		...
		if (!Config.LogLowGems && ["gzvs", "glys", "glbs", "glgs", "glrs", "glws", "skls", "gcv", "gcy", "gcb", "gcg", "gcr", "gcw", "skc", "gfv", "gfy", "gfb", "gfg", "gfr", "gfw", "skf", "gsv", "gsy", "gsb", "gsg", "gsr", "gsw", "sku"].indexOf(unit.code) > -1) {
			return false;
		}

		if (!Config.LogHighGems && ["gpvs", "gpys", "gpbs", "gpgs","gprs", "gpws", "skzs", "gzv", "gly", "glb", "glg", "glr", "glw", "skl", "gpv", "gpy", "gpb", "gpg", "gpr", "gpw", "skz"].indexOf(unit.code) > -1) {
			return false;
		}
