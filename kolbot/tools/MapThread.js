	...
	text: {
		...
		add: function (name) {
			...
			case "monsterStatus":
				this.hooks.push({
					name: "monsterStatus",
					hook: new Text("Num 7: Disable Monsters", 495, 485)
				});
			...
			case "vectorStatus":
				this.hooks.push({
					name: "vectorStatus",
					hook: new Text("Num 8: Disable Vectors", 495, 495)
				});
		...
		add: function (area) {
			...
			case 2: // Blood Moor
				this.hooks.push({
					...
					hook: new Text("Num 4: " + Pather.getAreaName(8), 150, 495 - (this.hooks.length * 10))
				});
			...
			case 3: // Cold Plains
				this.hooks.push({
					...
					hook: new Text("Num 4: " + Pather.getAreaName(17), 150, 495 - (this.hooks.length * 10))
				});
			...
			case 6: // Black Marsh
				this.hooks.push({
					...
					hook: new Text("Num 4: " + Pather.getAreaName(20), 150, 495 - (this.hooks.length * 10))
				});
			...
			case 7: // Tamoe Highlands
				this.hooks.push({
					...
					hook: new Text("Num 4: " + Pather.getAreaName(12), 150, 495 - (this.hooks.length * 10))
				});
			...
			case 10: // Underground Passage Level 1
				this.hooks.push({
					...
					hook: new Text("Num 4: " + Pather.getAreaName(14), 150, 495 - (this.hooks.length * 10))
				});
			...
			case 17: // Burial Grounds
				this.hooks.push({
					...
					hook: new Text("Num 4: " + Pather.getAreaName(19), 150, 495 - (this.hooks.length * 10))
				});
			...
			case 41: // Rocky Waste
				this.hooks.push({
					...
					hook: new Text("Num 4: " + Pather.getAreaName(55), 150, 495 - (this.hooks.length * 10))
				});
			...
			case 42: // Dry Hills
				this.hooks.push({
					...
					hook: new Text("Num 4: " + Pather.getAreaName(56), 150, 495 - (this.hooks.length * 10))
				});
			...
			case 43: // Far Oasis
				this.hooks.push({
					...
					hook: new Text("Num 4: " + Pather.getAreaName(62), 150, 495 - (this.hooks.length * 10))
				});
			...
			case 44: // Lost City
				this.hooks.push({
					...
					hook: new Text("Num 4: " + Pather.getAreaName(65), 150, 495 - (this.hooks.length * 10))
				});
			...
			case 76: // Spider Forest
				this.hooks.push({
					...
					hook: new Text("Num 4: " + Pather.getAreaName(85), 150, 495 - (this.hooks.length * 10))
				});
			...
			case 78: // Flayer Jungle
				this.hooks.push({
					...
					hook: new Text("Num 4: " + Pather.getAreaName(88), 150, 495 - (this.hooks.length * 10))
				});
			...
			case 80: // Kurast Bazaar
				this.hooks.push({
					...
					hook: new Text("Num 4: " + Pather.getAreaName(94), 150, 495 - (this.hooks.length * 10))
				});
			...
			case 81: // Upper Kurast
				this.hooks.push({
					...
					hook: new Text("Num 4: " + Pather.getAreaName(92), 150, 495 - (this.hooks.length * 10))
				});
			...
			case 92: // Sewers Level 1
				this.hooks.push({
					...
					hook: new Text("Num 4: " + Pather.getAreaName(80), 150, 495 - (this.hooks.length * 10))
				});
			...
			case 113: // Crystalline Passage
				this.hooks.push({
					...
					hook: new Text("Num 4: " + Pather.getAreaName(114), 150, 495 - (this.hooks.length * 10))
				});
			...
			case 115: // Glacial Trail
				this.hooks.push({
					...
					hook: new Text("Num 4: " + Pather.getAreaName(116), 150, 495 - (this.hooks.length * 10))
				});
			...
			case 118: // Ancient's Way
				this.hooks.push({
					...
					hook: new Text("Num 4: " + Pather.getAreaName(119), 150, 495 - (this.hooks.length * 10))
				});
			...
			if (poi) {
				this.hooks.push({
					...
					hook: new Text("Num 3: " + poi.name, 150, 495 - (this.hooks.length * 10))
				});
			}
			...
			if (wp) {
				this.hooks.push({
					...
					hook: new Text("Num 2: WP", 150, 495 - (this.hooks.length * 10))
				});
			}
				...
				for (i = 0; i < exits.length; i += 1) {
					if (exits[i].target === this.prevAreas[me.area]) {
						this.hooks.push({
							...
							hook: new Text("Num 1: " + Pather.getAreaName(this.prevAreas[me.area]), 150, 495 - (this.hooks.length * 10))
						});
				...
				for (i = 0; i < exits.length; i += 1) {
					if (exits[i].target === nextAreas[me.area]) {
						this.hooks.push({
							...
							hook: new Text("Num 0: " + Pather.getAreaName(nextAreas[me.area]), 150, 495 - (this.hooks.length * 10))
						});
					...
					for (i = 0; i < exits.length; i += 1) {
						if (exits[i].target === this.prevAreas.indexOf(me.area)) {
							this.hooks.push({
								...
								hook: new Text("Num 0: " + Pather.getAreaName(this.prevAreas.indexOf(me.area)), 150, 495 - (this.hooks.length * 10))
							});
